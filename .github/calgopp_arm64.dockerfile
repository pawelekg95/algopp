...
RUN apt-get update && \
    ...
    python3=3.8.2-0ubuntu2 python3-pip=20.0.2-5ubuntu1.6 shellcheck=0.7.0-2build2 make=4.2.1-1.2 \
    clang-format=1:10.0-50~exp1 clang-tidy=1:10.0-50~exp1 xz-utils=5.2.4-1ubuntu1.1 valgrind=1:3.15.0-1ubuntu9.1 \
    lcov=1.14-2 curl=7.68.0-1ubuntu2.13 gnupg=2.2.19-3ubuntu2.2 \
    diffutils=1:3.7-3 && \
