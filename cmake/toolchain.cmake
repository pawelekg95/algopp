...
if("${TOOLCHAIN}" STREQUAL "clang")
    ...
    set(CMAKE_C_COMPILER clang${EXE_EXTENSION} CACHE INTERNAL "")
    set(CMAKE_CXX_COMPILER clang++${EXE_EXTENSION} CACHE INTERNAL "")
elseif("${TOOLCHAIN}" STREQUAL "gcc")
    message("GCC toolchain specified")
    set(CMAKE_C_COMPILER gcc${EXE_EXTENSION} CACHE INTERNAL "")
    set(CMAKE_CXX_COMPILER g++${EXE_EXTENSION} CACHE INTERNAL "")
else()
